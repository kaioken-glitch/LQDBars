...
import { faHeart as faHeartSolid, faTrashCan } from '@fortawesome/free-solid-svg-icons';
...
export default function RecentlyPlayed() {
  ...
  return (
    <div className="recentlyPlayed w-full h-full flex flex-col overflow-hidden">
      {/* Sticky header */}
      <div className="sticky top-0 z-10 w-full px-4 md:px-6 py-4 backdrop-blur-2xl bg-black/30 border-b border-white/10">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            hover:bg-white/20 transition-all text-white/90 text-sm font-medium"
          >
            Clear All
          </button>
        </div>
                  ...
                  <div className="relative aspect-square overflow-hidden">
                    ...
                    transition-opacity flex items-center justify-center">
                      <button
                        ...
                        className="w-12 h-12 rounded-full bg-emerald-500 hover:bg-emerald-600 
                        flex items-center justify-center shadow-lg transform hover:scale-110 transition"
                      >
